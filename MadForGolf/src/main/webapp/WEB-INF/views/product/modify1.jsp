                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="product-img" href="${pageContext.request.contextPath }/resources/product_img/${vo.prod_img }" title="Product Image">
                                        <img src="${pageContext.request.contextPath }/resources/product_img/${vo.prod_img }" alt="1" style="height: 440px; width: 308px; margin-left: 80px;">
                                    </a>
                                    </div>
...
<!--                                 </ol> -->
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc" style="width: 410px;">
                            <h4 class="title"><input type="text" value="${vo.prod_name }" name="prod_name"></h4>
                            <h4 class="price"><%-- <fmt:formatNumber value="${vo.price }"/>원 --%>
                            <input type="text" value="${vo.price }" name="price">원</h4>
                            <div class="short_overview">
                                <p><textarea>${vo.detail }</textarea></p>
                            </div>
							prod_name,price,datail
...
<%--                                 <p><span>Condition:</span> <span><input type="text" value="${vo.condition }" name="condition"></span></p>
 --%>                           <p><span>Condition:</span> <span>${vo.condition }</span></p>
<%--                                 <p><span>Gender:</span> <span><c:if test="${vo.gender eq 1}">남</c:if><c:if test="${vo.gender eq 2}">여</c:if>
                                <input type="text" value="<c:if test="${vo.gender eq 1}">남</c:if><c:if test="${vo.gender eq 2}">여</c:if>" name="gender"></span></p> --%>
                                <p><span>Gender:</span><span><c:if test="${vo.gender eq 1}">남</c:if><c:if test="${vo.gender eq 2}">여</c:if></span></p>
<%--                                 <p><span>Category:</span> <span><input type="text" value="${vo.category }" name="category"></span></p>
 --%>                                
                                 <p><span>Category:</span> <span>${vo.category }</span></p>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active" id="description"  style="text-align: center;">
                                <div class="description_area">
                                    ...
                                    <!-- 수정하기 get  -->
                                    <input type="submit" id="button2" value="수정하기"<%--  onclick="location.href='${pageContext.request.contextPath }/product/modify?prod_num=${vo.prod_num}'" --%>>
                                    
                                    <form action="${pageContext.request.contextPath }/product/modify?category=${vo.category}&prod_name=${vo.prod_name}&price=${vo.price}&detail=${vo.detail}&condition =${vo.condition}&gender=${vo.gender}&category=${vo.category}&prod_img=${vo.prod_img}" method="post"> 
                                    
                                    <input type="submit" id="button2" value="수정하기">
                                    </form>
                                    <!-- 수정하기 get  -->
                                  <!--   condition =null,gender=0,category='',prod_img=null -->
