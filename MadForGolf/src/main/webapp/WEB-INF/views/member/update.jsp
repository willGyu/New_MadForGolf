                        ...
                        <form action="${pageContext.request.contextPath }/member/updatePro" id="update" method="post">
                            <div class="row">
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="email" class="form-control" id="email_address" name="user_id" value="${vo.user_id }" readonly>
                                </div>
                                
                                <div class="col-md-6 mb-4">
                                    <label for="first_name">Name *</label>
                                    <input type="text" class="form-control" id="first_name" name="user_name" value="${vo.user_name }" required="">
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="last_name">Password *</label>
                                    <input type="password" class="form-control" id="last_name" name="user_pw" value="${vo.user_pw }" required="">
                                </div>
                                <div class="col-12 mb-4">
                                    <label for="email_address">Phone Number *</label>
                                    <input type="number" class="form-control" id="email_address" name="user_phone" value="${vo.user_phone }">
                                </div>
                                <div class="col-12 mb-4">
